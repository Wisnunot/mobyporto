    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-48">
        <div class="max-w-3xl">
            <h1 class="text-4xl md:text-6xl font-extrabold text-white tracking-tight mb-6 leading-tight">
                Drive Your Ambition with <span class="text-accent">Moby</span>
            </h1>
            <p class="text-xl text-gray-300 mb-10 max-w-2xl leading-relaxed">
                Experience the finest selection of premium vehicles. We bring you uncompromised quality, transparent pricing, and an exceptional buying experience.
            </p>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="flex justify-between items-end mb-10">
        <div>
            <h2 class="text-sm font-bold tracking-widest text-secondary uppercase mb-2">Exclusive Selection</h2>
            <h3 class="text-3xl md:text-4xl font-extrabold text-primary">Featured Cars</h3>
        </div>
...
<div class="bg-primary py-24 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            <h2 class="text-sm font-bold tracking-widest text-accent uppercase mb-2">Our Advantage</h2>
            <h3 class="text-3xl md:text-4xl font-extrabold text-white">Why Choose Moby</h3>
            <p class="mt-4 text-lg text-gray-400">We don't just sell cars, we deliver peace of mind and an unmatched buying experience.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h4 class="text-xl font-bold text-white mb-3">Certified Quality</h4>
                <p class="text-gray-400 leading-relaxed">Every vehicle undergoes a rigorous 150-point inspection before it reaches our showroom floor.</p>
            </div>
            ...
            <div class="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h4 class="text-xl font-bold text-white mb-3">Financing Assistance</h4>
                <p class="text-gray-400 leading-relaxed">We work with top lenders to provide competitive rates and flexible financing tailored to you.</p>
            </div>
            ...
            <div class="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h4 class="text-xl font-bold text-white mb-3">Trusted Dealer</h4>
                <p class="text-gray-400 leading-relaxed">Years of experience and hundreds of happy customers stand behind our reputation for excellence.</p>
            </div>
            ...
            <div class="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                ...
                <h4 class="text-xl font-bold text-white mb-3">Fast Process</h4>
                <p class="text-gray-400 leading-relaxed">Streamlined paperwork and transparent procedures get you on the road in your new car faster.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
            <div class="px-4">
                ...
                <div class="text-sm font-bold text-gray-500 uppercase tracking-wide">Cars Sold</div>
            </div>
            <div class="px-4">
                <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">99<span class="text-secondary">%</span></div>
                <div class="text-sm font-bold text-gray-500 uppercase tracking-wide">Happy Customers</div>
            </div>
            <div class="px-4">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
    <div class="text-center mb-16">
        <h2 class="text-3xl md:text-4xl font-extrabold text-primary">What Our Customers Say</h2>
    </div>
...
<div id="contact" class="bg-slate-100 py-20 border-t border-slate-200">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl md:text-5xl font-extrabold text-primary mb-6">Ready to Find Your Dream Car?</h2>
        <p class="text-xl text-gray-600 mb-10">Our automotive experts are ready to assist you. Contact us via WhatsApp for a quick response and personalized consultation.</p>
